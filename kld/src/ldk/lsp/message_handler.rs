use crate::ldk::lsp::msgs::{LSPSMessage, RawLSPSMessage, LSPS_MESSAGE_TYPE};
use crate::ldk::lsp::protocol::LSPS0MessageHandler;
        ...
        self.pending_messages
            ...
            .map(|(public_key, lsps_message)| {
                ...
                (
                    public_key,
                    RawLSPSMessage {
                        payload: serde_json::to_string(&lsps_message).unwrap(),
                    },
                )
            })
            .collect()
